...
if pagamento == 'A Prazo':
    ...
    if totalcompra < 800 and parcelas >= 6:
        ...
        totalcompra = totalcompra + (totalcompra * 5/100)
    elif parcelas == 12:
        totalcompra = totalcompra + (totalcompra * 6.5/100)
    elif parcelas == 13:
        totalcompra = totalcompra + (totalcompra * 7/100)
    elif parcelas == 14:
        totalcompra = totalcompra + (totalcompra * 9/100)
    elif parcelas == 15:
        totalcompra = totalcompra + (totalcompra * 9.5/100)
    elif parcelas == 16:
       totalcompra = totalcompra + (totalcompra * 10/100)
    elif parcelas == 17:
        totalcompra = totalcompra + (totalcompra * 11.3/100)
    elif parcelas == 18:
        totalcompra = totalcompra + (totalcompra * 12/100)
    else:
